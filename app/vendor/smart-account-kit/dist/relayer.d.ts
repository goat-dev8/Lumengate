 ...
 */
export declare const RelayerErrorCodes: {
    readonly INVALID_PARAMS: "INVALID_PARAMS";
    readonly INVALID_XDR: "INVALID_XDR";
    readonly POOL_CAPACITY: "POOL_CAPACITY";
    readonly SIMULATION_FAILED: "SIMULATION_FAILED";
    readonly ONCHAIN_FAILED: "ONCHAIN_FAILED";
    readonly INVALID_TIME_BOUNDS: "INVALID_TIME_BOUNDS";
    readonly FEE_LIMIT_EXCEEDED: "FEE_LIMIT_EXCEEDED";
...
export declare class RelayerClient {
    ...
    private asObject;
    private looksLikeErrorCode;
    private extractResponseData;
    private hasTransactionFields;
     ...
     * ```
     */
    send(func: string, auth: string[], options?: RelayerSendOptions): Promise<RelayerResponse>;
    /**
     ...
     * ```
     */
    sendXdr(transaction: Transaction | string, options?: RelayerSendOptions): Promise<RelayerResponse>;
    /**
