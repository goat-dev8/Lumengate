...
const SYNC_KEYS = [
  ...
  'CONFIDENTIAL_USDC_TOKEN_ID',
  'CONFIDENTIAL_USDC_VERIFIER_ID',
  'CONFIDENTIAL_USDC_AUDITOR_ID',
  'CONFIDENTIAL_USDC_POLICY_ID',
  'CONFIDENTIAL_USDC_UNDERLYING_ID',
  'CONFIDENTIAL_USDC_DEPLOYED_AT_LEDGER',
  'CONFIDENTIAL_USDC_AUDITOR_ID_NUM',
];
